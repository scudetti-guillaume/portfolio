...
export class CarousselComponent {
  ...
  projects: any[] = [
    { name: 'Mot de passe', image: '../../assets/logoprojets/motdepasse.png', logoGit: '../../assets/icones/github.png', lienGit: 'https://github.com/scudetti-guillaume/jeu_ahmedlndy_mot_de_passe', logoSite: '../../assets/icones/site-web.png', lienSite: 'https://lesiteduscudo.com/', title: 'Mot de passe', description: 'un jeu où à tour de rôle les joueurs en binôme doivent deviner une liste de mots sous la direction du gamemaster', technoFront: 'React , socket.io ', technoBack: ' Express, JWT , MongoDB', flipped: false },
